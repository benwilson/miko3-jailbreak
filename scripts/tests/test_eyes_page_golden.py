...
def compile_harness(jdk, out_dir, main, source_roots):
    ...
    r = subprocess.run(jvm_harness.javac_cmd(jdk[0], out_dir, [main], [HARNESS] + list(source_roots)),
...
jvm_harness.add_scenario_tests(VoiceEyesHarnessTest)
